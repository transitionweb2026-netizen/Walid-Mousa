...
export const videos: VideoItem[] = [
  ...
  {
    id: "v9",
    slug: "peyronie-when-a-bend-needs-treating",
    title: { en: "Peyronie's: when a curve needs treating", ar: "بيروني: متى يحتاج الاعوجاج إلى علاج" },
    description: {
      en: "Which curves settle on their own, which respond to injections, and which need surgery.",
      ar: "أي انحناءات تستقر وحدها، وأيها يستجيب للحقن، وأيها يحتاج جراحة.",
    },
    thumbnail: { src: IMG.manReading, alt: { en: "Peyronie's disease explainer video", ar: "فيديو شرح مرض بيروني" } },
    youtubeId: "aqz-KE-bpKQ",
    aspect: "portrait",
    duration: "4:05",
    category: { en: "Surgery", ar: "الجراحة" },

...
const HERO_FIELDS: SectionFieldDef[] = [
  ...
  { path: "description", label: "Description", type: "textarea", bilingual: true },
  { path: "image_id", label: "Hero Cover Image (Desktop)", type: "media", mediaCategory: "hero", help: "Shown at tablet width and up. Recommended: wide landscape, roughly 1920×1080 or wider." },
  { path: "image_position", label: "Desktop Image Focal Point (e.g. \"center 20%\")", type: "text" },
  { path: "image_mobile_id", label: "Hero Cover Image (Mobile)", type: "media", mediaCategory: "hero", help: "Shown on phones (below tablet width). Recommended: a taller crop, roughly 750×1000. Leave empty to reuse the desktop image." },
  { path: "image_mobile_position", label: "Mobile Image Focal Point (e.g. \"center 20%\")", type: "text" },
